				...
				<div className="max-w-4xl mx-auto space-y-16">
					...
					<div className="text-center space-y-6">
						...
						>
							<Badge
								variant="outline"
								className="mb-4 py-1 px-4 border-blue-500/30 bg-blue-500/5 text-blue-500 font-mono"
							>
							...
							<div className="grid md:grid-cols-2">
								<div className="p-8 md:p-12 space-y-6">
									...
									<div className="flex flex-wrap gap-3">
										<Badge
											variant="secondary"
											className="bg-background/50 backdrop-blur-sm border-white/5 font-mono text-xs"
										>
											<Users className="mr-1.5 h-3 w-3" />{" "}
											{t("support.community.members")}
										</Badge>
										<Badge
											variant="secondary"
											className="bg-background/50 backdrop-blur-sm border-white/5 font-mono text-xs"
								...
								<div className="bg-muted/30 p-8 md:p-12 border-l border-white/5 flex flex-col justify-center gap-6">
									<div className="space-y-4">
										...
										<div className="flex items-start gap-4">
											...
											<div>
												<p className="font-semibold text-sm">
													{t("support.feature2.title")}
												</p>
												<p className="text-xs text-muted-foreground">
													{t("support.feature2.desc")}
												</p>
											</div>
										</div>
										<div className="flex items-start gap-4">
											...
											<div>
												<p className="font-semibold text-sm">
													{t("support.feature3.title")}
												</p>
												<p className="text-xs text-muted-foreground">
													{t("support.feature3.desc")}
												</p>
											</div>
										</div>
									</div>
				...
				<div className="container mx-auto px-4">
					<div className="flex flex-col md:flex-row justify-between items-center gap-6">
						...
						<div className="flex gap-4">
							...
							<a
								href="https://github.com/Nestfeed-app"
								className="text-muted-foreground hover:text-primary transition-colors"
							>
								<GithubIcon className="h-5 w-5" />
							</a>
