...
export const Route = createFileRoute("/_app/privacy")({
	...
	head: () => ({
		meta: [
			{ title: "Privacy Policy – Groupify" },
			{
				name: "description",
				content:
					"How Groupify collects, uses and protects your data, including cookies, analytics and third-party advertising disclosures.",
			},
		],
		links: [{ rel: "canonical", href: "https://groupify.dev/privacy" }],
	}),
});
				...
				<article className="typography">
					...
					<ul>
						...
						<li>
							...
							<p>Type: Persistent Cookies</p>
							<p>Administered by: Third-Party advertisers</p>
							<p>
								Purpose: These Cookies are set by Google and its advertising
								partners to deliver ads, measure their performance and, where
								you have given consent, personalize them based on your browsing
								across websites.
							</p>
						</li>
					</ul>
					...
					<h3>Advertising and Third-Party Vendors</h3>
					<p>
						We use third-party advertising vendors, including Google, to serve
						ads on our Website through Google AdSense. Third-party vendors,
						including Google, use cookies (such as the DoubleClick DART cookie)
					...
					<ul>
						<li>
							<p>
								...
								to serve ads to You based on Your visit to our Website and/or
						...
						<li>
							<p>
								Where required by law (including the EEA and the UK), we request
								your consent before using advertising cookies or serving
								personalized ads. Until consent is given, ads are served in a
								non-personalized manner. You can change or withdraw your choice
								at any time via the cookie banner displayed on our Website.
							</p>
						</li>
					</ul>
					...
					<ul>
						...
						<li>
							...
							<a href="https://groupify.dev/contact">groupify.dev/contact</a>
						</li>
					</ul>
				</article>
			</div>
