...
export const Route = createFileRoute("/_app/terms")({
	...
	head: () => ({
		meta: [
			{ title: "Terms of Service – Groupify" },
			{
				name: "description",
				content:
					"Terms of Service for Groupify: the rules and guidelines for using our website, dashboard and shared group features.",
			},
		],
		links: [{ rel: "canonical", href: "https://groupify.dev/terms" }],
	}),
});
...
function RouteComponent() {
	return (
		<div className="min-h-screen bg-background flex flex-col">
			<div className="flex m-10 items-start justify-center flex-1">
				<article className="typography">
					...
					<p>
						...
						(together or individually "Service") operated by Groupify
					...
					<p>
						...
						are and will remain the exclusive property of Groupify and its
					...
					<p>
						...
						or through the Service. By submitting content, you grant Groupify a
					...
					<p>
						...
						If a revision is material, we will provide at least 7 days’ notice
						before new terms take effect. Your continued use of the Service
						after the revisions come into effect constitutes your agreement to
					...
					<ul>
						<li>
							By email:{" "}
							<a href="mailto:admin@nestfeed.app">admin@nestfeed.app</a>
						</li>
					</ul>
				</article>
			</div>
