# Groupify.dev — Spec-Driven Development
...
- Veja `specs/002-google-adsense-approval/` para um exemplo de referência.
  (O número `001` foi usado por um sample descartado — não reutilizar.)

## Regras

- **Não há código sem spec** (para trabalho não-trivial — ≥20 linhas ou mudança
  em contrato público: props de componentes, rotas, API contracts, exported APIs)
...
| Exemplo completo | `specs/002-google-adsense-approval/` |
