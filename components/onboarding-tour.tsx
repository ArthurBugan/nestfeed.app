...
const STEP_ICONS: Record<string, React.ElementType> = {
	welcome: Sparkles,
	"connect-youtube": YoutubeIcon,
	"google-connect-btn": YoutubeIcon,
...
export function OnboardingTour() {
	...
	const [spotlightTarget, setSpotlightTarget] = useState<HTMLElement | null>(
		null,
	);
	...
	return (
		<>
				...
				{hasSpotlight && spotlightRect && (
					<div
						...
						style={{
							...
							boxShadow:
								"0 0 20px rgba(239, 68, 68, 0.2), inset 0 0 20px rgba(239, 68, 68, 0.1)",
						}}
					/>
				)}
			</div>
			...
			<div className="fixed inset-0 z-[9999] flex items-start justify-center pointer-events-none p-4">
				<div className="pointer-events-auto w-full max-w-lg mt-8">
